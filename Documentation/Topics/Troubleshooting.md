...
__This is not bug in ResX Resource Manager!__ This seems to be a caching problem in Visual Studios extension loader/manager, or using an outdated Version of Visual Studio.

### Solution

#### Always make sure you have updated Visual Studio to the latest version, so VS does not refers to older dependencies than the ResXManager extension
